...
(function ($) {
    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        _addfilterwidget: function (columnrecord, tablecolumn, width) {
            ...
            switch (columnrecord.filtertype) {
                ...
                case 'input':
                    ...
                    dropdownlist.jqxDropDownList({ disabled: me.disabled, touchMode: me.touchmode, rtl: me.rtl, dropDownHorizontalAlignment: 'right', enableBrowserBoundsDetection: true, selectedIndex: selectedIndex, width: 20, height: 27, dropDownHeight: 150, dropDownWidth: dropDownWidth, source: source, theme: me.theme });
        ...
        _updatefilterpanel: function (me, element, column) {
            ...
            if (this._hasdatefilter && (column.filtertype !== "list" && column.filtertype !== "checkedlist" && column.filtertype !== "custom")) {
                ...
                if (column.filtertype == "date") {
                    ...
                    var input = $("<input class='filtertext1" + me.element.id + "' style='box-sizing: content-box; height: 16px; padding: 3px;' type='text'></input>");
                    filter1.append(input);
                    var initInput = function (input) {
                    ...
                    var input = $("<input class='filtertext2" + me.element.id + "' style='box-sizing: content-box; height: 16px; padding: 3px;' type='text'></input>");
                    filter2.append(input);
                    initInput(input);
                }
                var input1 = $element.find('.filtertext1' + me.element.id);
        ...
        _initfilterpanel: function (me, element, column, width, excelMode) {
            ...
            element.append(filterpanelcontainer);
            var showwhere = $("<div class='filter' style='height: 18px; margin-top: 3px; margin-bottom: 3px;'></div>");
            ...
            var input = $("<div style='margin-top:3px;' class='filter'><input class='filtertext1" + me.element.id + "' style='padding: 3px; height: 17px; margin-top: 3px; margin-bottom: 3px;' type='text'></input></div>");
            ...
            var input2 = $("<div style='margin-top:3px;' class='filter'><input class='filtertext2" + me.element.id + "' style='padding: 3px; height: 17px; margin-top: 3px;' type='text'></input></div>");
            ...
            var applyinput = $("<div class='filter' style='height: 25px; text-align:center; margin-top: 12px; margin-left:-2px;'></div>");
            var filterbutton = $('<span tabIndex=0 id="filterbutton' + me.element.id + '" class="filterbutton" style="padding: 4px 12px;">' + me.gridlocalization.filterstring + '</span>');
            applyinput.append(filterbutton);
            var filterclearbutton = $('<span tabIndex=0 id="filterclearbutton' + me.element.id + '" class="filterclearbutton" style="position: relative; left: 1px; padding: 4px 12px; margin-left: 7px;">' + me.gridlocalization.filterclearstring + '</span>');
...
(function ($) {
    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        _initfilterpanel: function (me, element, column, width, excelMode) {
            ...
            var filterbutton = $('<span tabIndex=0 id="filterbutton' + me.element.id + '" class="filterbutton" style="padding: 4px 12px;">' + me.gridlocalization.filterstring + '</span>');
            applyinput.append(filterbutton);
            var filterclearbutton = $('<span tabIndex=0 id="filterclearbutton' + me.element.id + '" class="filterclearbutton" style="position: relative; left: 2px; padding: 4px 12px; margin-left: 7px;">' + me.gridlocalization.filterclearstring + '</span>');
            applyinput.append(filterclearbutton);
