                ...
                case "dropdownlist":
                    if (this.host.jqxDropDownList) {
                        ...
                        if (dropdownlisteditor == undefined) {
                            ...
                            editor.jqxDropDownList({hint:false, enableBrowserBoundsDetection: true, keyboardSelection: false, source: dataadapter, rtl: this.rtl, autoDropDownHeight: autoheight, theme: this.theme, width: $element.width(), height: $element.height(), displayMember: displayfield, valueMember: datafield });
                ...
                case "combobox":
                    if (this.host.jqxComboBox) {
                        ...
                        if (comboboxeditor == undefined) {
                            ...
                            var autoheight = !column.createeditor ? true: false;
                            editor.jqxComboBox({ hint: false, enableBrowserBoundsDetection: true, keyboardSelection: false, source: dataadapter, rtl: this.rtl, autoDropDownHeight: autoheight, theme: this.theme, width: $element.width(), height: $element.height(), displayMember: displayfield, valueMember: datafield });
                ...
                case "datetimeinput":
                    if (this.host.jqxDateTimeInput) {
                        ...
                        if (dateeditor == undefined) {
                            ...
                            editor.jqxDateTimeInput({ hint: false, firstDayOfWeek: this.gridlocalization.firstDay, enableBrowserBoundsDetection: true, localization: localization, _editor: true, theme: this.theme, rtl: this.rtl, width: $element.width(), height: $element.height(), formatString: column.cellsformat });
                ...
                case "numberinput":
                    if (this.host.jqxNumberInput) {
                        ...
                        if (numbereditor == undefined) {
                            ...
                            editor.jqxNumberInput({decimalSeparator: this.gridlocalization.decimalseparator, decimalDigits: digits, inputMode: 'simple', theme: this.theme, rtl: this.rtl, width: $element.width() , height: $element.height() , spinButtons: true, symbol: symbol, symbolPosition: symbolPosition });
