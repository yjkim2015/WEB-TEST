                            ...
                            if (aggregates) {
                                if (column.aggregatesRenderer) {
                                    if (aggregates) {
                                        ...
                                        var aggregateKeys = Object.keys(aggregates[column.datafield]);

                                        row[column.displayfield] += name + ':' + aggregates[column.datafield][aggregateKeys[0]] + "\n";
                                    }
                                }
                                else {
                                    cellvalue = "";
                        ...
                        if (this.checkboxes && !row.aggregate) {
                            ...
                            if (hasCheckbox) {
                                if (info) {
                                    ...
                                    if (checked) {
                                        checkbox += "<span checked='true' class='" + checkClassName + "'><div class='" + that.toThemeProperty('jqx-tree-grid-checkbox-tick') + " " + that.toThemeProperty('jqx-checkbox-check-checked') + "'></div></span>";
                                    }
                                    else if (checked === false) {
                                        checkbox += "<span checked='undefined' class='" + checkClassName + "'></span>";
                                    }
                                    else {
