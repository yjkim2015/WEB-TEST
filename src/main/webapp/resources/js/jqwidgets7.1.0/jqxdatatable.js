...
(function ($) {
    ...
    $.extend($.jqx._jqxDataTable.prototype, {
        ...
        _initpager: function () {
            ...
            this.pagerdiv = this.pagerdiv || $('<div style="line-height: 28px; width: 100%; height: 100%; position: relative;"></div>');
            this.toppagerdiv = this.toppagerdiv || $('<div style="line-height: 28px; width: 100%; height: 100%; position: relative;"></div>');
            if (!this.pageable) {
            ...
            if (!this.pagerRenderer) {
                ...
                var createPagerElements = function (pagerdiv, name) {
                    var that = this;
                    var input = $('<div style="margin-right: 12px; height: 28px; float: right;"><input style="height:100%; box-sizing: border-box; text-align: right; width: 36px;" type="text"/></div>');
                    ...
                    if (that.pagerMode != "default") {
                        ...
                        pagershowrowscombo.jqxDropDownList({ _checkForHiddenParent: false, rtl: that.rtl, disabled: that.disabled, source: source, enableBrowserBoundsDetection: true, keyboardSelection: false, autoDropDownHeight: true, width: 'auto', height: 28, theme: that.theme });
                        var selectedindex = 0;
                ...
                if (me.showAggregates) {
                    if (me.getcolumnaggregateddata) {
                        if (me.treeGrid) {
                            ...
                            aggregates.push(me.getcolumnaggregateddata(this.displayfield, this.aggregates, true, getRecords(rows, [])));
                        }
                        else {
...
//                    that._renderrows(false);
        ...
        _renderfilter: function () {
            ...
            var filterElement =
               ...
               + "<input style='width: 200px; height: 22px; direction: ltr;' role='textbox' type='text'/>"
