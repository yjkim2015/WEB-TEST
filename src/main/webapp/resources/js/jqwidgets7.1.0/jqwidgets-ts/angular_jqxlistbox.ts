...
export class jqxListBoxComponent implements ControlValueAccessor, OnChanges, AfterViewInit, AfterViewChecked 
{
   ...
   @Input('dragStart') attrDragStart: (item:ListBoxDragStart['item']) => boolean;
   @Input('dragEnd') attrDragEnd: (dragItem: ListBoxDragEnd['dragItem'], dropItem: ListBoxDragEnd['dropItem']) => boolean;
   ...
   @Input('renderer') attrRenderer: (index: ListBoxRenderer['index'], label: ListBoxRenderer['label'], value: ListBoxRenderer['value']) => string;
 ...
 ngAfterViewChecked() {
   ...
   dragStart(arg?: (item:ListBoxDragStart['item']) => boolean) : any {
   ...
   dragEnd(arg?: (dragItem: ListBoxDragEnd['dragItem'], dropItem: ListBoxDragEnd['dropItem']) => boolean) : any {
   ...
   renderer(arg?: (index: ListBoxRenderer['index'], label: ListBoxRenderer['label'], value: ListBoxRenderer['value']) => string) : any {
