...
export class jqxPivotGridComponent implements OnChanges
{
   ...
   @Input('itemsRenderer') attrItemsRenderer: (pivotItem: PivotGridItemsRenderer['pivotItem']) => string;
   @Input('cellsRenderer') attrCellsRenderer: (pivotCell: PivotGridCellsRenderer['pivotCell']) => string;
   ...
   itemsRenderer(arg?: (pivotItem: PivotGridItemsRenderer['pivotItem']) => string) : any {
      if (arg !== undefined) {
   ...
   cellsRenderer(arg?: (pivotCell: PivotGridCellsRenderer['pivotCell']) => string) : any {
      if (arg !== undefined) {
