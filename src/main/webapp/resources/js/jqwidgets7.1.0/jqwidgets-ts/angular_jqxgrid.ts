...
export class jqxGridComponent implements OnChanges, AfterViewInit, AfterViewChecked
{
   ...
   @Input('columnmenuopening') attrColumnmenuopening: (menu?: GridColumnmenuopening['menu'], datafield?: GridColumnmenuopening['datafield'], height?: GridColumnmenuopening['height']) => boolean;
   @Input('columnmenuclosing') attrColumnmenuclosing: (menu?: GridColumnmenuclosing['menu'], datafield?: GridColumnmenuclosing['datafield'], height?: GridColumnmenuclosing['height']) => boolean;
   @Input('cellhover') attrCellhover: (cellhtmlElement?: GridCellhover['cellhtmlElement'], x?: GridCellhover['x'], y?: GridCellhover['y']) => void;
   ...
   @Input('groupsrenderer') attrGroupsrenderer: (text?: GridGroupsrenderer['text'], group?: GridGroupsrenderer['group'], expanded?: GridGroupsrenderer['expanded'], data?: GridGroupsrenderer['data']) => string;
   @Input('groupcolumnrenderer') attrGroupcolumnrenderer: (text?: GridGroupcolumnrenderer['text']) => string;
   @Input('groupsexpandedbydefault') attrGroupsexpandedbydefault: boolean;
   @Input('handlekeyboardnavigation') attrHandlekeyboardnavigation: (event: GridHandlekeyboardnavigation['event']) => boolean;
   ...
   @Input('scrollfeedback') attrScrollfeedback: (row: GridScrollfeedback['row']) => string;
   ...
   @Input('filter') attrFilter: (cellValue?: GridFilter['cellValue'], rowData?: GridFilter['rowData'], dataField?: GridFilter['dataField'], filterGroup?: GridFilter['filterGroup'], defaultFilterResult?: GridFilter['defaultFilterResult']) => any;
   ...
   @Input('renderstatusbar') attrRenderstatusbar: (statusbar?: GridRenderstatusbar['statusbar']) => void;
   @Input('rendertoolbar') attrRendertoolbar: (toolbar?: GridRendertoolbar['toolbar']) => void;
...
;                options['source'] = result.source;                
 ...
 ngAfterViewChecked() {
   ...
   columnmenuopening(arg?: (menu?: GridColumnmenuopening['menu'], datafield?: GridColumnmenuopening['datafield'], height?: GridColumnmenuopening['height']) => boolean) : any {
   ...
   columnmenuclosing(arg?: (menu?: GridColumnmenuclosing['menu'], datafield?: GridColumnmenuclosing['datafield'], height?: GridColumnmenuclosing['height']) => boolean) : any {
   ...
   cellhover(arg?: (cellhtmlElement?: GridCellhover['cellhtmlElement'], x?: GridCellhover['x'], y?: GridCellhover['y']) => void) : any {
   ...
   groupsrenderer(arg?: (text?: GridGroupsrenderer['text'], group?: GridGroupsrenderer['group'], expanded?: GridGroupsrenderer['expanded'], data?: GridGroupsrenderer['data']) => string) : any {
   ...
   groupcolumnrenderer(arg?: (text?: GridGroupcolumnrenderer['text']) => string) : any {
   ...
   handlekeyboardnavigation(arg?: (event: GridHandlekeyboardnavigation['event']) => boolean) : any {
   ...
   scrollfeedback(arg?: (row: GridScrollfeedback['row']) => string) : any {
   ...
   filter(arg?: (cellValue?: GridFilter['cellValue'], rowData?: GridFilter['rowData'], dataField?: GridFilter['dataField'], filterGroup?: GridFilter['filterGroup'], defaultFilterResult?: GridFilter['defaultFilterResult']) => any) : any {
   ...
   renderstatusbar(arg?: (statusbar?: GridRenderstatusbar['statusbar']) => void) : any {
   ...
   rendertoolbar(arg?: (toolbar?: GridRendertoolbar['toolbar']) => void) : any {
