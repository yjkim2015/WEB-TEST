...
export class jqxDataTableComponent implements OnChanges, AfterViewInit, AfterViewChecked
{
   ...
   @Input('groupsRenderer') attrGroupsRenderer: (value?:DataTableGroupsRenderer['value'], rowData?:DataTableGroupsRenderer['rowdata'], level?:DataTableGroupsRenderer['level']) => string;
   @Input('initRowDetails') attrInitRowDetails: (id?:DataTableInitRowDetails['id'], row?:DataTableInitRowDetails['row'], element?:DataTableInitRowDetails['element'], rowInfo?:DataTableInitRowDetails['rowinfo']) => void;
   ...
   @Input('renderToolbar') attrRenderToolbar: (toolbar?:DataTableRenderToolbar['toolbar']) => void;
   @Input('renderStatusBar') attrRenderStatusBar: (statusbar?:DataTableRenderStatusBar['statusbar']) => void;
...
;                options['source'] = result.source;                
 ...
 ngAfterViewChecked() {
   ...
   groupsRenderer(arg?: (value?:DataTableGroupsRenderer['value'], rowData?:DataTableGroupsRenderer['rowdata'], level?:DataTableGroupsRenderer['level']) => string) : any {
   ...
   initRowDetails(arg?: (id?:DataTableInitRowDetails['id'], row?:DataTableInitRowDetails['row'], element?:DataTableInitRowDetails['element'], rowInfo?:DataTableInitRowDetails['rowinfo']) => void) : any {
   ...
   renderToolbar(arg?: (toolbar?:DataTableRenderToolbar['toolbar']) => void) : any {
   ...
   renderStatusBar(arg?: (statusbar?:DataTableRenderStatusBar['statusbar']) => void) : any {
