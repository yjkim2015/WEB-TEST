...
{
   @Input('columnRenderer') attrColumnRenderer: (element?: KanbanColumnRenderer['element'], collapsedElement?: KanbanColumnRenderer['collapsedElement'], column?: KanbanColumnRenderer['column']) => void;
   ...
   @Input('itemRenderer') attrItemRenderer: (element?: KanbanItemRenderer['element'], item?: KanbanItemRenderer['item'], resource?: KanbanItemRenderer['resource']) => void;
   ...
   columnRenderer(arg?: (element?: KanbanColumnRenderer['element'], collapsedElement?: KanbanColumnRenderer['collapsedElement'], column?: KanbanColumnRenderer['column']) => void) : any {
      if (arg !== undefined) {
   ...
   itemRenderer(arg?: (element?: KanbanItemRenderer['element'], item?: KanbanItemRenderer['item'], resource?: KanbanItemRenderer['resource']) => void) : any {
      if (arg !== undefined) {
