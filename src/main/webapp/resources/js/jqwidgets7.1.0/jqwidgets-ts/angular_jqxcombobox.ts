...
export class jqxComboBoxComponent implements ControlValueAccessor, OnChanges, AfterViewInit, AfterViewChecked 
{
   ...
   @Input('renderer') attrRenderer: (index?: ComboBoxRenderer['index'], label?: ComboBoxRenderer['label'], value?: ComboBoxRenderer['value']) => string;
   @Input('renderSelectedItem') attrRenderSelectedItem: (index?: ComboBoxRenderSelectedItem['index'], item?: ComboBoxRenderSelectedItem['item']) => string;
   ...
   @Input('search') attrSearch: (searchString?: ComboBoxSearch['searchString']) => void;
   @Input('source') attrSource: any;
   @Input('scrollBarSize') attrScrollBarSize: number | string;
   @Input('template') attrTemplate: any;
   @Input('theme') attrTheme: string;
   @Input('validateSelection') attrValidateSelection: (itemValue?: ComboBoxValidateSelection['itemValue']) => boolean;
 ...
 ngAfterViewChecked() {
   ...
   renderer(arg?: (index?: ComboBoxRenderer['index'], label?: ComboBoxRenderer['label'], value?: ComboBoxRenderer['value']) => string) : any {
   ...
   renderSelectedItem(arg?: (index?: ComboBoxRenderSelectedItem['index'], item?: ComboBoxRenderSelectedItem['item']) => string) : any {
   ...
   search(arg?: (searchString?: ComboBoxSearch['searchString']) => void) : any {
   ...
   validateSelection(arg?: (itemValue?: ComboBoxValidateSelection['itemValue']) => boolean) : any {
