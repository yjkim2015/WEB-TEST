...
export class jqxToolBarComponent implements OnChanges
{
   ...
   @Input('tools') attrTools: string | 'button' | 'toggleButton' | 'dropdownlist' | 'combobox' | 'input' | 'custom';
   ...
   tools(arg?: string | 'button' | 'toggleButton' | 'dropdownlist' | 'combobox' | 'input' | 'custom') : any {
      if (arg !== undefined) {
