...
export class jqxChartComponent implements OnChanges
{
   ...
   @Input('drawBefore') attrDrawBefore: (renderer?: ChartDrawBefore['renderer'], rect?: ChartDrawBefore['rect']) => void;
   @Input('draw') attrDraw: (renderer?: ChartDraw['renderer'], rect?: ChartDraw['rect']) => void;
   ...
   drawBefore(arg?: (renderer?: ChartDrawBefore['renderer'], rect?: ChartDrawBefore['rect']) => void) : any {
      if (arg !== undefined) {
   ...
   draw(arg?: (renderer?: ChartDraw['renderer'], rect?: ChartDraw['rect']) => void) : any {
      if (arg !== undefined) {
