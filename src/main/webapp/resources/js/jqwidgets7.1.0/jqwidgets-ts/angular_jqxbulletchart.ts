...
export class jqxBulletChartComponent implements OnChanges
{
   ...
   @Input('labelsFormatFunction') attrLabelsFormatFunction: (value?: BulletChartLabelsFormatFunction['value'], position?: BulletChartLabelsFormatFunction['position']) => any;
   ...
   @Input('tooltipFormatFunction') attrTooltipFormatFunction: (pointerValue?: BulletChartTooltipFormatFunction['pointerValue'], targetValue?: BulletChartTooltipFormatFunction['targetValue']) => string;
   ...
   labelsFormatFunction(arg?: (value?: BulletChartLabelsFormatFunction['value'], position?: BulletChartLabelsFormatFunction['position']) => any) : any {
      if (arg !== undefined) {
   ...
   tooltipFormatFunction(arg?: (pointerValue?: BulletChartTooltipFormatFunction['pointerValue'], targetValue?: BulletChartTooltipFormatFunction['targetValue']) => string) : any {
      if (arg !== undefined) {
