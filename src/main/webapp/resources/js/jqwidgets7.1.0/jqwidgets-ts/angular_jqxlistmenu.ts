...
export class jqxListMenuComponent implements OnChanges
{
   ...
   @Input('filterCallback') attrFilterCallback: (text:ListMenuFilterCallback['text'], searchValue:ListMenuFilterCallback['searchValue']) => boolean;
   ...
   filterCallback(arg?: (text:ListMenuFilterCallback['text'], searchValue:ListMenuFilterCallback['searchValue']) => boolean) : any {
      if (arg !== undefined) {
