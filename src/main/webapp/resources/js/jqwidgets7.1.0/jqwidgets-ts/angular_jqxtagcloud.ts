...
export class jqxTagCloudComponent implements OnChanges
{
   ...
   @Input('tagRenderer') attrTagRenderer: (itemData: TagCloudTagRenderer['itemData'], minValue: TagCloudTagRenderer['minValue'], valueRange: TagCloudTagRenderer['valueRange']) => any;
   ...
   tagRenderer(arg?: (itemData: TagCloudTagRenderer['itemData'], minValue: TagCloudTagRenderer['minValue'], valueRange: TagCloudTagRenderer['valueRange']) => any) : any {
      if (arg !== undefined) {
