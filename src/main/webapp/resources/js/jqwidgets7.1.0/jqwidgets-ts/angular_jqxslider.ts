...
export class jqxSliderComponent implements ControlValueAccessor, OnChanges 
{
   ...
   @Input('tickLabelFormatFunction') attrTickLabelFormatFunction: (value: SliderTickLabelFormatFunction['value']) => string;
   ...
   @Input('tooltipFormatFunction') attrTooltipFormatFunction: (value: SliderTooltipFormatFunction['value']) => any;
   ...
   tickLabelFormatFunction(arg?: (value: SliderTickLabelFormatFunction['value']) => string) : any {
      if (arg !== undefined) {
   ...
   tooltipFormatFunction(arg?: (value: SliderTooltipFormatFunction['value']) => any) : any {
      if (arg !== undefined) {
