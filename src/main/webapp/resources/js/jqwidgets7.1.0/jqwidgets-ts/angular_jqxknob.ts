...
export class jqxKnobComponent implements OnChanges
{
   ...
   @Input('changing') attrChanging: (oldValue: KnobChanging['oldValue'], newValue: KnobChanging['newValue']) => boolean;
   ...
   changing(arg?: (oldValue: KnobChanging['oldValue'], newValue: KnobChanging['newValue']) => boolean) : any {
      if (arg !== undefined) {
