...
export class jqxProgressBarComponent implements OnChanges
{
   ...
   @Input('renderText') attrRenderText: (text?: ProgressBarRenderText['text'], value?: ProgressBarRenderText['value']) => string;
   ...
   renderText(arg?: (text?: ProgressBarRenderText['text'], value?: ProgressBarRenderText['value']) => string) : any {
      if (arg !== undefined) {
