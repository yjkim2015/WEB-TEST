...
export class jqxTreeComponent implements OnChanges
{
   ...
   @Input('dragStart') attrDragStart: (item: TreeDragStart['item']) => boolean;
   @Input('dragEnd') attrDragEnd: (dragItem?: TreeDragEnd['dragItem'], dropItem?: TreeDragEnd['dropItem'], args?: TreeDragEnd['args'], dropPosition?: TreeDragEnd['dropPosition'], tree?: TreeDragEnd['tree']) => boolean;
   ...
   dragStart(arg?: (item: TreeDragStart['item']) => boolean) : any {
      if (arg !== undefined) {
   ...
   dragEnd(arg?: (dragItem?: TreeDragEnd['dragItem'], dropItem?: TreeDragEnd['dropItem'], args?: TreeDragEnd['args'], dropPosition?: TreeDragEnd['dropPosition'], tree?: TreeDragEnd['tree']) => boolean) : any {
      if (arg !== undefined) {
