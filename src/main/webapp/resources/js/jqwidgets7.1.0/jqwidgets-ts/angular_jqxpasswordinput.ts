...
export class jqxPasswordInputComponent implements ControlValueAccessor, OnChanges 
{
   ...
   @Input('passwordStrength') attrPasswordStrength: (password:PasswordInputPasswordStrength['password'], characters:PasswordInputPasswordStrength['characters'], defaultStrength:PasswordInputPasswordStrength['defaultStrength']) => string;
   ...
   @Input('strengthTypeRenderer') attrStrengthTypeRenderer: (password:PasswordInputStrengthTypeRenderer['password'], characters:PasswordInputStrengthTypeRenderer['characters'], defaultStrength:PasswordInputStrengthTypeRenderer['defaultStrength']) => string;
   ...
   passwordStrength(arg?: (password:PasswordInputPasswordStrength['password'], characters:PasswordInputPasswordStrength['characters'], defaultStrength:PasswordInputPasswordStrength['defaultStrength']) => string) : any {
      if (arg !== undefined) {
   ...
   strengthTypeRenderer(arg?: (password:PasswordInputStrengthTypeRenderer['password'], characters:PasswordInputStrengthTypeRenderer['characters'], defaultStrength:PasswordInputStrengthTypeRenderer['defaultStrength']) => string) : any {
      if (arg !== undefined) {
