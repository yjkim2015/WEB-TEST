...
export class jqxRangeSelectorComponent implements OnChanges
{
   ...
   @Input('groupLabelsFormatFunction') attrGroupLabelsFormatFunction: (value: RangeSelectorGroupLabelsFormatFunction['value'], date: RangeSelectorGroupLabelsFormatFunction['date']) => string;
   @Input('labelsFormat') attrLabelsFormat: any;
   @Input('labelsFormatFunction') attrLabelsFormatFunction: (value: RangeSelectorLabelsFormatFunction['value']) => string;
   @Input('labelsOnTicks') attrLabelsOnTicks: boolean;
   @Input('markersFormat') attrMarkersFormat: any;
   @Input('markersFormatFunction') attrMarkersFormatFunction: (value: RangeSelectorMarkersFormatFunction['value'], position: RangeSelectorMarkersFormatFunction['position']) => string;
   ...
   groupLabelsFormatFunction(arg?: (value: RangeSelectorGroupLabelsFormatFunction['value'], date: RangeSelectorGroupLabelsFormatFunction['date']) => string) : any {
      if (arg !== undefined) {
   ...
   labelsFormatFunction(arg?: (value: RangeSelectorLabelsFormatFunction['value']) => string) : any {
      if (arg !== undefined) {
   ...
   markersFormatFunction(arg?: (value: RangeSelectorMarkersFormatFunction['value'], position: RangeSelectorMarkersFormatFunction['position']) => string) : any {
      if (arg !== undefined) {
