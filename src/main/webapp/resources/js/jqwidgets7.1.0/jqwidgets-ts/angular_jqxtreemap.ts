...
export class jqxTreeMapComponent implements OnChanges
{
   ...
   @Input('legendScaleCallback') attrLegendScaleCallback: (v: TreeMapLegendScaleCallback['v']) => string | number;
   ...
   legendScaleCallback(arg?: (v: TreeMapLegendScaleCallback['v']) => string | number) : any {
      if (arg !== undefined) {
