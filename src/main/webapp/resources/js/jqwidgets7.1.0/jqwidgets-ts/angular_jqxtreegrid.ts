...
export class jqxTreeGridComponent implements OnChanges, AfterViewInit, AfterViewChecked
{
   ...
   @Input('rowDetailsRenderer') attrRowDetailsRenderer: (key: TreeGridRowDetailsRenderer['key'], dataRow: TreeGridRowDetailsRenderer['dataRow']) => any;
   @Input('renderToolbar') attrRenderToolbar: (toolBar?: TreeGridRenderToolbar['toolbar']) => void;
   @Input('renderStatusBar') attrRenderStatusBar: (statusBar?: TreeGridRenderStatusBar['statusbar']) => void;
...
;                options['source'] = result.source;                
 ...
 ngAfterViewChecked() {
   ...
   rowDetailsRenderer(arg?: (key: TreeGridRowDetailsRenderer['key'], dataRow: TreeGridRowDetailsRenderer['dataRow']) => any) : any {
   ...
   renderToolbar(arg?: (toolBar?: TreeGridRenderToolbar['toolbar']) => void) : any {
   ...
   renderStatusBar(arg?: (statusBar?: TreeGridRenderStatusBar['statusbar']) => void) : any {
   ...
   sortBy(dataField: number | string, sortOrder?: jqwidgets.'asc' | 'desc' | null): void {
