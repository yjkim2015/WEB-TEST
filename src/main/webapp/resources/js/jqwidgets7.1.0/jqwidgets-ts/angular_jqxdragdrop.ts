...
export class jqxDragDropComponent implements OnChanges
{
   ...
   @Input('onDrag') attrOnDrag: (data?: DragDropOnDrag['data'], position?: DragDropOnDrag['position']) => void;
   @Input('onDragStart') attrOnDragStart: (position?: DragDropOnDragStart['position']) => void;
   @Input('onTargetDrop') attrOnTargetDrop: (data?: DragDropOnTargetDrop['data']) => void;
   @Input('onDropTargetEnter') attrOnDropTargetEnter: () => void;
   @Input('onDropTargetLeave') attrOnDropTargetLeave: (data?: DragDropOnDropTargetLeave['data']) => void;
   @Input('restricter') attrRestricter: object | 'body' | 'document' | 'parent';
   ...
   onDrag(arg?: (data?: DragDropOnDrag['data'], position?: DragDropOnDrag['position']) => void) : any {
      if (arg !== undefined) {
   ...
   onDragStart(arg?: (position?: DragDropOnDragStart['position']) => void) : any {
      if (arg !== undefined) {
   ...
   onTargetDrop(arg?: (data?: DragDropOnTargetDrop['data']) => void) : any {
      if (arg !== undefined) {
   ...
   onDropTargetLeave(arg?: (data?: DragDropOnDropTargetLeave['data']) => void) : any {
      if (arg !== undefined) {
   ...
   restricter(arg?: jqwidgets.object | 'body' | 'document' | 'parent') : any {
      if (arg !== undefined) {
