...
export class jqxSchedulerComponent implements OnChanges
{
   ...
   @Input('contextMenuOpen') attrContextMenuOpen: (menu: SchedulerContextMenuOpen['menu'], appointment: SchedulerContextMenuOpen['appointment'], event: SchedulerContextMenuOpen['event']) => void;
   @Input('contextMenuClose') attrContextMenuClose: (menu: SchedulerContextMenuClose['menu'], appointment: SchedulerContextMenuClose['appointment'], event: SchedulerContextMenuClose['event']) => void;
   @Input('contextMenuItemClick') attrContextMenuItemClick: (menu: SchedulerContextMenuItemClick['menu'], appointment: SchedulerContextMenuItemClick['appointment'], event: SchedulerContextMenuItemClick['event']) => boolean;
   @Input('contextMenuCreate') attrContextMenuCreate: (menu: SchedulerContextMenuCreate['menu'], settings: SchedulerContextMenuCreate['settings']) => void;
   ...
   @Input('editDialogOpen') attrEditDialogOpen: (dialog?: SchedulerEditDialogOpen['dialog'], fields?: SchedulerEditDialogOpen['fields'], editAppointment?: SchedulerEditDialogOpen['editAppointment']) => void;
   @Input('editDialogCreate') attrEditDialogCreate: (dialog?: SchedulerEditDialogCreate['dialog'], fields?: SchedulerEditDialogCreate['fields'], editAppointment?: SchedulerEditDialogCreate['editAppointment']) => void;
   @Input('editDialogKeyDown') attrEditDialogKeyDown: (dialog?: SchedulerEditDialogKeyDown['dialog'], fields?: SchedulerEditDialogKeyDown['fields'], editAppointment?: SchedulerEditDialogKeyDown['editAppointment'], event?: SchedulerEditDialogKeyDown['event']) => boolean;
   @Input('editDialogClose') attrEditDialogClose: (dialog?: SchedulerEditDialogClose['dialog'], fields?: SchedulerEditDialogClose['fields'], editAppointment?: SchedulerEditDialogClose['editAppointment']) => void;
   ...
   @Input('renderAppointment') attrRenderAppointment: (data: SchedulerRenderAppointment['data']) => any;
   ...
   contextMenuOpen(arg?: (menu: SchedulerContextMenuOpen['menu'], appointment: SchedulerContextMenuOpen['appointment'], event: SchedulerContextMenuOpen['event']) => void) : any {
      if (arg !== undefined) {
   ...
   contextMenuClose(arg?: (menu: SchedulerContextMenuClose['menu'], appointment: SchedulerContextMenuClose['appointment'], event: SchedulerContextMenuClose['event']) => void) : any {
      if (arg !== undefined) {
   ...
   contextMenuItemClick(arg?: (menu: SchedulerContextMenuItemClick['menu'], appointment: SchedulerContextMenuItemClick['appointment'], event: SchedulerContextMenuItemClick['event']) => boolean) : any {
      if (arg !== undefined) {
   ...
   contextMenuCreate(arg?: (menu: SchedulerContextMenuCreate['menu'], settings: SchedulerContextMenuCreate['settings']) => void) : any {
      if (arg !== undefined) {
   ...
   editDialogOpen(arg?: (dialog?: SchedulerEditDialogOpen['dialog'], fields?: SchedulerEditDialogOpen['fields'], editAppointment?: SchedulerEditDialogOpen['editAppointment']) => void) : any {
      if (arg !== undefined) {
   ...
   editDialogCreate(arg?: (dialog?: SchedulerEditDialogCreate['dialog'], fields?: SchedulerEditDialogCreate['fields'], editAppointment?: SchedulerEditDialogCreate['editAppointment']) => void) : any {
      if (arg !== undefined) {
   ...
   editDialogKeyDown(arg?: (dialog?: SchedulerEditDialogKeyDown['dialog'], fields?: SchedulerEditDialogKeyDown['fields'], editAppointment?: SchedulerEditDialogKeyDown['editAppointment'], event?: SchedulerEditDialogKeyDown['event']) => boolean) : any {
      if (arg !== undefined) {
   ...
   editDialogClose(arg?: (dialog?: SchedulerEditDialogClose['dialog'], fields?: SchedulerEditDialogClose['fields'], editAppointment?: SchedulerEditDialogClose['editAppointment']) => void) : any {
      if (arg !== undefined) {
   ...
   renderAppointment(arg?: (data: SchedulerRenderAppointment['data']) => any) : any {
      if (arg !== undefined) {
